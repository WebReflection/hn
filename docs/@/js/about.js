...
<div>
<p>
Hello there, I am Andrea Giammarchi, aka <a href=https://twitter.com/WebReflection>@webreflection</a>, and I am the developer behind this project.
</p>
<p>
...
<a href=https://github.com/WebReflection/ucontent#readme>µcontent</a> libraries, able to produce a fully static, yet <em>SSR</em> ready, <em>Hacker News</em> reader.
</p>
...
<h2>Extra Details</h2>
<p>
All sources are <a href=https://github.com/WebReflection/hn>available on GitHub</a>, and all you need to do, in order to test this project locally, is the following:
</p>
<pre>
...
<p>
The <em>client</em> side part is within the <code>client/@/</code> folder, while the <em>server</em> side part is within the <code>server</code> folder.
</p>
<p>
The reason to choose a <code>@</code> as folder prefix, is to have a portable pattern that would never interfere with the name of any other possible folder.
</p>
<p>
As example, the <em>SSR</em> part uses those folders indexes to render each page, but the structure is fully compatible with a static host too.
</p>
<p>
The client side is served either through <a href=https://github.com/WebReflection/ucdn#readme>µcdn</a>, or pre-built via <a href=https://github.com/WebReflection/ucompress#readme>µcompress</a>, after a <code>npm run build</code> command.
</p>
<p>
To keep it simple, I have also targeted the <code>docs</code> folder, instead of <code>public</code>, simply to be able to tell GitHub to publish this Web App via such folder.
</p>
<p>
