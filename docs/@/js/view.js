const e=(a=[])=>a.reduce((a,t)=>a+e((t.model||{}).comments),a.length),a=(e,a)=>(1!==(e>>>=0)&&(a+="s"),`${e} ${a}`),t=(e,a)=>e===a?"selected":"",o=()=>{scrollTo({top:0,left:0,behavior:"smooth"})};let s=0;const n=new Map,l=(e=Date.now(),t=Date.now()/1e3)=>{const o=t-e;return o<3600?a(o/60,"minute"):o<86400?a(o/3600,"hour"):a(o/86400,"day")};export default({html:a})=>{const r=({model:t={comments:[]}})=>a`
...
<div>
${a(n.get(t.text||"...")||(e=>{s||(s=setTimeout(()=>{s=0,n.clear()},1e4));const a=[e];return n.set(e,a),a})(t.text||"..."))}
</div>
...
`,main:(e,t,s,n)=>a`
<main class=stories>
${c(e,s,n)} ${t.map(({index:e,model:t={}})=>a`
<article class=${t.id?"":"placeholder"}>
<div>${e}</div>
<div>
<h2>
<a onclick=${t.url?Object:o} href=${t.url||"../item/?"+t.id} rel=noopener>${t.title||"..."}
<small>
...
<p>
<a href=${"https://news.ycombinator.com/submitted?id="+o} rel=noopener>submissions</a> /
<a href=${"https://news.ycombinator.com/threads?id="+o} rel=noopener>comments</a> /
<a href=${"https://news.ycombinator.com/favorites?id="+o} rel=noopener>favourites</a>
</p>
